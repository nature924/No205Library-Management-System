			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<h4>
							<i class="mdi mdi-format-align-justify"></i>新闻公告信息列表
						</h4>
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<c:forEach items="${articleList}" var="article">
							<tr>
								...
								<td style="text-align: center;"><a href="article/getArticleById.action?id=${article.articleid}"><i
										class="mdi mdi-table-edit"></i>编辑</a>&nbsp;&nbsp;<a href="article/deleteArticle.action?id=${article.articleid}"
									onclick="{if(confirm('确定要删除吗?')){return true;}return false;}"><i class="mdi mdi-delete"></i>删除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
