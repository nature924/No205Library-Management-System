			...
			<div class="col-md-6">
				<div class="card">
					<div class="card-header">
						<h4>
							<i class="mdi mdi-table-edit"></i>编辑图书类型信息
						</h4>
						<ul class="card-actions">
							<li><a class="btn btn-primary m-r-5" href="cate/getAllCate.action">返回</a></li>
							<li><a class="btn btn-primary m-r-5" href="cate/getCateById.action?id=${cate.cateid}">刷新</a></li>
						</ul>
					</div>
					<div class="card-body">
						<form class="form-horizontal" action="cate/updateCate.action" method="post">
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input type="text" name="memo" class="form-control" id="memo" value="${cate.memo}" />
								</div>
							</div>
